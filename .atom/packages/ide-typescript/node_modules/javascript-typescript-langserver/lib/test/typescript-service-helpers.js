...
exports.initializeTypeScriptService = (createService, rootUri, files, clientCapabilities = DEFAULT_CAPABILITIES) => function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        this.client.workspaceXfiles.callsFake((params) => {
            return util_1.observableFromIterable(files.keys()).map(uri => ({ uri })).toArray();
        });
...
function describeTypeScriptService(createService, shutdownService = shutdownTypeScriptService, rootUri) {
    describe('Workspace without project files', function () {
        ...
        describe('textDocumentDefinition()', function () {
            specify('in same file', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.textDocumentDefinition({
                        textDocument: {
                            uri: rootUri + 'a.ts'
                        },
                        position: {
                    ...
                    }).reduce(fast_json_patch_1.applyReducer, null).toPromise();
        ...
        describe('textDocumentXdefinition()', function () {
            specify('on interface field reference', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.textDocumentXdefinition({
                        textDocument: {
                            uri: rootUri + 'e.ts'
                        },
                        position: {
        ...
        describe('textDocumentHover()', function () {
            specify('in same file', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.textDocumentHover({
                        textDocument: {
                            uri: rootUri + 'a.ts'
                        },
                        position: {
    ...
    describe('Workspace with typings directory', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
        ...
        describe('textDocumentDefinition()', function () {
            ...
            describe('on file in project root', function () {
    ...
    describe('Workspace with root package.json', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
        ...
        afterEach(shutdownService);
        describe('workspaceSymbol()', function () {
            describe('with SymbolDescriptor query', function () {
            ...
            describe('with text query', function () {
                it('should find a symbol', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        const result = yield this.service.workspaceSymbol({ query: 'a' }).reduce(fast_json_patch_1.applyReducer, null).toPromise();
                        assert.deepEqual(result, [{
                                kind: vscode_languageserver_types_1.SymbolKind.Class,
                                location: {
                                    range: {
                ...
                it('should return all symbols for an empty query excluding dependencies', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        const result = yield this.service.workspaceSymbol({ query: '' })
        ...
        describe('workspaceXreferences()', function () {
            it('should return all references to a method', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: { name: 'foo', kind: 'method', containerName: 'a' } })
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [{
                            symbol: {
            ...
            it('should return all references to a method with hinted dependee package name', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: { name: 'foo', kind: 'method', containerName: 'a' }, hints: { dependeePackageName: 'mypkg' } })
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [{
                            symbol: {
            ...
            it('should return no references to a method if hinted dependee package name was not found', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: { name: 'foo', kind: 'method', containerName: 'a' }, hints: { dependeePackageName: 'NOT-mypkg' } }).reduce(fast_json_patch_1.applyReducer, null).toPromise();
                    assert.deepEqual(result, []);
                });
            });
            it('should return all references to a symbol from a dependency', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: { name: 'x' } })
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [{
                            reference: {
            ...
            it('should return all references to a symbol from a dependency with PackageDescriptor query', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: { name: 'x', package: { name: 'dep' } } })
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [{
                            reference: {
            ...
            it('should return all references to all symbols if empty SymbolDescriptor query is passed', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: {} })
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [
                        {
    ...
    describe('Dependency detection', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'package.json', JSON.stringify({
                    name: 'tslint',
                    version: '4.0.2',
        ...
        afterEach(shutdownService);
        describe('workspaceXdependencies()', function () {
            it('should account for all dependencies', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXdependencies()
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [
        ...
        describe('workspaceXpackages()', function () {
            it('should accournt for all packages', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXpackages()
                        .reduce(fast_json_patch_1.applyReducer, null)
                        .toPromise();
                    assert.deepEqual(result, [{
                            package: {
    ...
    describe('Live updates', function () {
        ...
        it('should handle didChange when configuration is not yet initialized', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield this.service.textDocumentHover(hoverParams)
                    .reduce(fast_json_patch_1.applyReducer, null)
                    .toPromise();
                assert.deepEqual(result, {
                    range,
    ...
    describe('TypeScript libraries', function () {
        ...
        describe('textDocumentDefinition()', function () {
            it('should resolve TS libraries to github URL', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    assert.deepEqual(yield this.service.textDocumentDefinition({
                        textDocument: {
                            uri: rootUri + 'a.ts'
                        },
                        position: {
    ...
    describe('textDocumentReferences()', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'a.ts', [
                    'class A {',
                    '	/** foo doc*/',
        ...
        it('should provide an empty response when no reference is found', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const result = yield this.service.textDocumentReferences({
                    textDocument: {
                        uri: rootUri + 'a.ts'
                    },
                    position: {
    ...
    describe('textDocumentSignatureHelp()', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'a.ts', [
                    'class A {',
                    '	/** foo doc*/',
        ...
        it('should provide a valid empty response when no signature is found', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const result = yield this.service.textDocumentSignatureHelp({
                    textDocument: {
                        uri: rootUri + 'a.ts'
                    },
                    position: {
    ...
    describe('textDocumentCompletion() with snippets', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'a.ts', [
                    'class A {',
                    '	/** foo doc*/',
        ...
        it('should produce completions', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const result = yield this.service.textDocumentCompletion({
                    textDocument: {
                        uri: rootUri + 'a.ts'
                    },
                    position: {
    ...
    describe('textDocumentCompletion()', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'a.ts', [
                    'class A {',
                    '	/** foo doc*/',
    ...
    describe('textDocumentRename()', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'package.json', JSON.stringify({ name: 'mypkg' })],
            [rootUri + 'a.ts', [
                    'class A {',
        ...
        it('should error on an invalid symbol', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield assert.isRejected(this.service.textDocumentRename({
                    textDocument: {
                        uri: rootUri + 'a.ts'
                    },
                    position: {
                    ...
                    newName: 'asdf'
                }).reduce(fast_json_patch_1.applyReducer, null).toPromise(), 'This symbol cannot be renamed');
            });
        });
        it('should return a correct WorkspaceEdit to rename a class', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const result = yield this.service.textDocumentRename({
                    textDocument: {
                        uri: rootUri + 'a.ts'
                    },
                    position: {
    ...
    describe('textDocumentCodeAction()', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'package.json', JSON.stringify({ name: 'mypkg' })],
            [rootUri + 'a.ts', [
                    'class A {',
        ...
        it('suggests a missing this', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const actions = yield this.service.textDocumentCodeAction({
                    textDocument: {
                        uri: rootUri + 'a.ts'
                    },
    ...
    describe('workspaceExecuteCommand()', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
            [rootUri + 'package.json', JSON.stringify({ name: 'mypkg' })],
            [rootUri + 'a.ts', [
                    'class A {',
        ...
        describe('codeFix', () => {
            it('should apply a WorkspaceEdit for the passed FileTextChanges', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    yield this.service.workspaceExecuteCommand({
                        command: 'codeFix',
                        arguments: [{
    ...
    describe('Special file names', function () {
        beforeEach(exports.initializeTypeScriptService(createService, rootUri, new Map([
