...
export declare class ProjectManager implements Disposable {
     ...
     */
    constructor(rootPath: string, inMemoryFileSystem: InMemoryFileSystem, updater: FileSystemUpdater, traceModuleResolution?: boolean, logger?: Logger);
    /**
...
export declare class ProjectConfiguration {
     ...
     */
    constructor(fs: InMemoryFileSystem, documentRegistry: ts.DocumentRegistry, rootFilePath: string, versions: Map<string, number>, configFilePath: string, configContent?: any, traceModuleResolution?: boolean, logger?: Logger);
    /**
