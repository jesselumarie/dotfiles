    ...
    getWorkspaceFiles(base = this.rootUri) {
        ...
        return new rxjs_1.Observable(subscriber => {
            ...
            globber.on('match', (file) => {
                subscriber.next(util_1.normalizeUri(base + file));
            });
...
class FileSystemUpdater {
    ...
    fetchStructure(childOf = new opentracing_1.Span()) {
        const observable = tracing_1.traceObservable('Fetch workspace structure', childOf, span => this.remoteFs.getWorkspaceFiles(undefined, span)
            .do(uri => {
    ...
    ensureStructure(childOf = new opentracing_1.Span()) {
        return tracing_1.traceObservable('Ensure structure', childOf, span => {
